...
#define _DUTY_MAX 2480 // servo full counterclockwise position (180 degree)
...
void loop() {
  ...
  if(dist_ema < _TARGET_LOW){
    ...
    //거리 비례 각도 0~180도 연속적으로 변화 ex)19->10도 27->90도 35->170도
    myServo.writeMicroseconds(_DUTY_MIN + (dist_ema - _TARGET_LOW) * (_DUTY_MAX - _DUTY_MIN) / (_TARGET_HIGH - _TARGET_LOW));
  }
